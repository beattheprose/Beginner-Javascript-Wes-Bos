...
const validArray = charArray.filter((letter) => /[a-zA-Z\d]/.test(letter));
...
const countObj = cleanArray.reduce(reducer, {});
console.table(countObj);
const sortByValue = (x, y) => y[1] - x[1];
const popularityContest = Object.entries(countObj).sort(sortByValue);
